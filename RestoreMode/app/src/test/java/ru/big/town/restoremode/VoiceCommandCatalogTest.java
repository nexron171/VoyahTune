...
public class VoiceCommandCatalogTest {
    ...
    @Test public void suspensionMaintenanceHasExplicitOppositeIntents() {
        assertAction("suspension_maintenance:on", "включить сервисный режим подвески",
                "включи сервисный режим подвески", "сервисный режим подвески",
                "включите режим обслуживания подвески", "подвески сервисный режим включи",
                "заблокировать подвеска", "заблокировать подвеску", "заблокируй подвеску",
                "заблокируйте подвеску пожалуйста");
        assertAction("suspension_maintenance:off", "выключить сервисный режим подвески",
                "выключи сервисный режим подвески", "отключить режим обслуживания подвески",
                "выключите сервисный режим подвески", "разблокировать подвеску",
                "разблокируй подвеску", "разблокируйте подвеска пожалуйста");
        assertAction("drive:OUTING", "поднять подвеску");
        for (String phrase : new String[]{"не заблокируй подвеску", "не разблокируй подвеску",
                "заблокируй или разблокируй подвеску", "включи выключи сервисный режим подвески",
                "заблокируй разблокируй подвеску", "заблокируй подвеску потом выключи фары",
                "выключи разблокируй подвеску", "блокируй подвеску", "зблокируй подвеску",
                "разблокирй подвеску"}) {
    ...
    @Test public void portCapsAcceptOpenAndShortPhrasesWithoutUnlockingConnector() {
        ...
        assertAction("sunroof:open", "открой люк", "открой люк крыши");
        for (String phrase : new String[]{"люк", "лючок", "открой лючок",
                ...
                "разблокируй зарядку", "разблокируй зарядный разъем"}) {
            assertNull(phrase, VoiceCommandCatalog.match(commands, phrase));
        }
        assertAction("energy:SREV", "топливо");
