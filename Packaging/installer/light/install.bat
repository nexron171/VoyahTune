...
if errorlevel 1 exit /b 1
adb.exe shell "rm -f /data/local/tmp/voyahtune_load.v2.lock /data/local/tmp/voyah_load.v2.lock /data/local/tmp/voyahtune_vd.pid /data/local/tmp/voyahtune_vd.attempt /data/local/tmp/voyahtune_vd_bypass.txt /data/local/tmp/voyahtune_vd_bypass.txt.try /data/local/tmp/voyahtune_swk_km.pid /data/local/tmp/voyahtune_swk_km.busy /data/local/tmp/voyahtune_swk_km.attempt /data/local/tmp/voyahtune_swk.txt /data/local/tmp/voyahtune_swk.try /data/local/tmp/voyahtune_lnch.pid /data/local/tmp/voyahtune_lnch.attempt /data/local/tmp/voyahtune_lnch.txt /data/local/tmp/voyahtune_lnch.txt.try /data/local/tmp/voyahtune_md.pid /data/local/tmp/voyahtune_md.attempt /data/local/tmp/voyahtune_md.txt /data/local/tmp/voyahtune_md.txt.try /data/local/tmp/voyahtune_apollo.pid /data/local/tmp/voyahtune_apollo.attempt /data/local/tmp/voyahtune_apollo.txt /data/local/tmp/voyahtune_apollo.txt.try /data/local/tmp/voyahtune_keyboard.pid /data/local/tmp/voyahtune_keyboard.attempt /data/local/tmp/voyahtune_keyboard.txt /data/local/tmp/voyahtune_keyboard.txt.try /data/local/tmp/voyahtune_fullscreen_client.* /data/local/tmp/voyahtune_load.txt /data/local/tmp/voyahtune-hook-status.v1 /data/local/tmp/voyahtune-hook-status.v1.*.new"
if errorlevel 1 exit /b 1
...
if errorlevel 1 exit /b 1
adb.exe shell "for removed_path in /system/etc/init/voyahtune.load.rc /system/etc/init.voyahtune.load.sh /system/etc/init/voyahtune.load.sh /data/local/bin/vd_bypass.js /data/local/bin/steeringwheelkeys.js /data/local/bin/launcherdock.js /data/local/bin/multidisplay.js /data/local/bin/fullscreen_client.js /data/local/bin/apollo_tech.js /data/local/bin/keyboard_lock_en.js /data/local/bin/keyboard_ru.js /data/local/bin/voyahtune-hook-manifest.json /data/local/tmp/voyahtune-hook-status.v1; do [ ! -e $removed_path ] && [ ! -L $removed_path ] || exit 1; done; ! ls /data/local/tmp/voyahtune_fullscreen_client.* >/dev/null 2>&1 || exit 1; sync"
exit /b %ERRORLEVEL%
