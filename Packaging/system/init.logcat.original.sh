...
# (без setenforce 0, telnetd и вечного цикла запуска load.bin). Используется переходной миграцией,
# чтобы вернуть непосредственную предыдущую установку к логированию без рут-обвязки.
