...
При опущенной панели водительский OEM one-button dock заменяется компактной раскладкой из Home,
двух пользовательских слотов и All Apps. Пассажирский compact dock остаётся штатным (только Home).
